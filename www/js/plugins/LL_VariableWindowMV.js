...
(function () {
      ...
      switch (args[0]) {
        case "show":
          ...
          if (!$gameSystem._LL_VariableWindow) {
            ...
            $gameSystem._LL_VariableWindow[1] = {
              variableId: null,
              x: 0,
              y: 0,
              width: 0,
            };
            $gameSystem._LL_VariableWindow[2] = {
              variableId: null,
              x: 0,
              y: 0,
              width: 0,
            };
            $gameSystem._LL_VariableWindow[3] = {
              variableId: null,
              x: 0,
              y: 0,
              width: 0,
            };
            $gameSystem._LL_VariableWindow[4] = {
              variableId: null,
              x: 0,
              y: 0,
              width: 0,
          ...
          $gameSystem._LL_VariableWindow[windowId] = {
  ...
  Window_ExVariableWindow.prototype.refresh = function () {
    if (this.getVariableId()) {
      ...
      this.drawText(
        $dataSystem.variables[this.getVariableId()],
        0,
        0,
        this.labelWidth()
      );
      this.resetTextColor();
      this.drawText(
        $gameVariables.value(this.getVariableId()),
        this.labelWidth(),
        0,
        this.width - this.padding * 2 - this.labelWidth(),
        "right"
      );
    } else {
      this.width = 0;
